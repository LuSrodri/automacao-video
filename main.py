...
8. A VOZ DEPENDE DO FORMATO desde 2026-09-03. No SHORT quem fala é a
   ...
   ESTE DESENHO SAIU E VOLTOU (2026-09-05): entre 04/09 e 05/09 o Short tentou
   ElevenLabs + um modelo de lipsync, para recuperar o corte de silêncio e o
   ajuste de velocidade. Nenhuma das três tentativas entregou lipsync que
   presta, e as portas fora do Wan estavam fechadas — o registro completo, com
   o que foi medido em cada uma, está no cabeçalho de `pipeline/influencer.py`.
