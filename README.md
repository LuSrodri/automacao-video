...
5. **GPT 5.6 Luna** escreve o roteiro **pré-conceitual**: como se fosse para alguém de 12 anos com metade da atenção — frases de **até 8 palavras**, uma ideia por frase, **vocabulário de criança** (sem jargão nem siglas), estrutura fixa **HOOK (imagem chocante, 0-2s) → FATO (2-15s) → IMPLICAÇÃO única (15-30s) → CORTE em tensão (30-35s)**, sem CTA falado. O título promete **exatamente** o que o vídeo entrega (1 fato real + 1 implicação — clickbait sem payload é proibido). O roteiro inclui **audio tags** (`[excited]`, `[whispers]`…) que ditam o tom da voz e define de **8 a 10 imagens-chave**.
