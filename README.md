...
| `QWEN_API_KEY` | — | Chave do **QwenCloud** (começa com `sk-ws-`), que faz o **lipsync da influencer do Short** com o `wan3.0-video` (ver `WAN_MODELO`). **Obrigatória no formato curto** — é a imagem de quem narra o clipe, e o `main.py` aborta no começo sem ela. A **voz** é da ElevenLabs desde 2026-09-04. O `--long-take` **não** a usa |
